...
const tempoObj1 = new Date("2024-12-20T00:00:00");
const tempoObj2 = new Date("2025-01-31T00:00:00");
const tempoObj3 = new Date("2029-12-30T00:00:00");
const tempoObj4 = new Date("2030-01-31T00:00:00");
...
function calculaTempo(tempObjetivo){
    ...
    let minutos  = Math.floor(segundos / 60); // converer em minutos
